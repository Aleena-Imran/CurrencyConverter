...
const swap = ()=>{
  ...
  <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat'
    ...
    <div className='w-full'>
      <div className='w-full max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden border border-gray-60'>
        <form onSubmit={(e)=>{
      e.preventDefault();
      convert()
        }}
          ...
          <button type='submit'
            className='w-full bg-blue-600 text-white rounded-lg px-4 py-2'>Convert {from.toUpperCase()} to {to.toUpperCase()}</button>
        </form>
      </div>
    </div>
  </div>
